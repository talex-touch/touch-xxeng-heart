...
function ensureStyles() {
  ensureStyleSheet('lexi-forum-digest-style', `
    ...
    .lexi-forum-digest { ${digestCardTokens} --lexi-text: #0d0d0d; --lexi-muted: #8e8e9a; --lexi-secondary: #5c5c66; --lexi-accent: #1976ff; --lexi-accent-strong: #0b57c7; --lexi-card-bg: #ffffff; --lexi-card-border: #e6e6ea; --lexi-card-shadow: 0 16px 40px -8px rgba(13,13,13,.17); --lexi-sidebar-shadow: 0 12px 32px -8px rgba(13,13,13,.12); --lexi-pill-bg: #edf3ff; --lexi-button-bg: #fff; --lexi-button-border: #d8d8de; --lexi-divider: #e6e6ea; --lexi-error-bg: rgba(254,242,242,.9); --lexi-error-text: #dc2626; --lexi-stale-bg: rgba(251,191,36,.16); --lexi-stale-text: #b45309; --lexi-loading-bg: #edf3ff; box-sizing: border-box; color-scheme: light; position: fixed; right: 18px; top: 96px; z-index: 2147483646; width: min(360px, calc(100vw - 36px)); max-height: min(54vh, 540px); overflow: auto; border: 1px solid var(--lexi-card-border); border-radius: 14px; background: var(--lexi-card-bg); box-shadow: var(--lexi-card-shadow); color: var(--lexi-text); padding: 13px; font: 13px/1.5 ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif; }
    ...
    .lexi-forum-digest__actions button:first-child { border-color: transparent; background: #0d0d0d; color: #fff; }
